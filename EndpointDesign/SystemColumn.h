...
public:
     ...
     */
    void addItem(MappingComponentItem* item, bool load = false);
     ...
     */
    void removeItem(MappingComponentItem* item);
     ...
     */
    void onMoveItem(MappingComponentItem* item, SystemColumn* oldColumn);
     ...
     */
    void onReleaseItem(MappingComponentItem* item);
