...
//-----------------------------------------------------------------------------
QMap<std::string, std::string> SystemComponentItem::getPropertyValues() const
{
...
{
    getComponentInstance()->setImportRef(nameRef.toStdString());
}
...
{
    return QString::fromStdString(getComponentInstance()->getImportRef());
}
