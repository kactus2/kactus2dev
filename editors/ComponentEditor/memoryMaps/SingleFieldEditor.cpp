...
void SingleFieldEditor::setupLayout()
{
    ...
    QVBoxLayout* enumerationEditorLayout = new QVBoxLayout();
    enumerationEditorLayout->addWidget(enumerationsEditor_, 1);
    ...
    topLayout->addLayout(enumerationEditorLayout, 1);
