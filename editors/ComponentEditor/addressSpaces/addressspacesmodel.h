...
/*! \brief The model class to manage the objects for address spaces editor.
 *
 */
class AddressSpacesModel : public QAbstractTableModel {
	Q_OBJECT
...
public:
	...
	*/
	...
	/*! \brief Check if the AddressSpaceModel is in a valid state.
	 *
