//-----------------------------------------------------------------------------
// File: TransactionalPortEditor.h
//-----------------------------------------------------------------------------
// Project: Kactus2
...
#ifndef TRANSACATIONAL_PORT_EDITOR_H
#define TRANSACATIONAL_PORT_EDITOR_H
...
class PortValidator;
class MasterTransactionalPortEditor;
...
//-----------------------------------------------------------------------------
class TransactionalPortEditor : public ItemEditor
{
    Q_OBJECT
...
public:
	 ...
	 */
	TransactionalPortEditor(QSharedPointer<Component> component,
     ...
     *  The destructor.
     */
	~TransactionalPortEditor() = default;
    ...
    TransactionalPortEditor& operator=(const TransactionalPortEditor& other) = delete;
