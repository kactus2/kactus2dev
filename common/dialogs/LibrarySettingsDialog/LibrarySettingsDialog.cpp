...
// 		this, SLOT(onSelectLocation(QListWidgetItem*, QListWidgetItem*)));
	...
	libLocationsTable_ = new QTableWidget(locationGroup);
	libLocationsTable_->setFixedHeight(120);
...
void LibrarySettingsDialog::onSelectLocation( QTableWidgetItem* cur, QTableWidgetItem* prev ) {
