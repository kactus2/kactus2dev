...
enum VariableType
{
    ...
    VAR_TYPE_LOCAL_NODE_ID      = 0x0001,
    VAR_TYPE_REMOTE_NODE_ID     = 0x0002,
    VAR_TYPE_NODE_ID            = VAR_TYPE_LOCAL_NODE_ID |  VAR_TYPE_REMOTE_NODE_ID,

    VAR_TYPE_LOCAL_PORT_ID      = 0x0004,
    VAR_TYPE_REMOTE_PORT_ID     = 0x0008,
    VAR_TYPE_PORT_ID            = VAR_TYPE_LOCAL_PORT_ID | VAR_TYPE_REMOTE_PORT_ID,

    VAR_TYPE_LOCAL_ENDPOINT     = 0x0010,
    VAR_TYPE_REMOTE_ENDPOINT    = 0x0020,
    VAR_TYPE_ENDPOINT           = VAR_TYPE_LOCAL_ENDPOINT | VAR_TYPE_REMOTE_ENDPOINT,

    VAR_TYPE_STATUS_PTR         = 0x0040,
    VAR_TYPE_ENDPOINT_HANDLE    = 0x0080,

    // Additional flags
    VAR_TYPE_CONN_IN            = 0x0100,
    VAR_TYPE_CONN_OUT           = 0x0200,
    VAR_TYPE_CONN_MSG           = 0x0400,
    VAR_TYPE_CONN_SCALAR        = 0x0800,
    VAR_TYPE_CONN_PACKET        = 0x1000,
