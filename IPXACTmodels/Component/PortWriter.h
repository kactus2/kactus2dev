...
namespace PortWriter
{
     ...
     */
    IPXACTMODELS_EXPORT void writePort(QXmlStreamWriter& writer, QSharedPointer<Port> port, Document::Revision docRevision);
    ...
    namespace Details
    {
         ...
         *    @param [in] docRevision     The applied IP-XACT standard revision.
         */
        void writeWire(QXmlStreamWriter& writer, QSharedPointer<Wire> wire, Document::Revision docRevision);
         ...
         */
        bool hasNonEmptyTypeDefinitions(QSharedPointer<QList<QSharedPointer<WireTypeDef> > > typeDefinitions);
         ...
         */
        void writeWireDriver(QXmlStreamWriter& writer, QSharedPointer<Driver> driver);
         ...
         */
        void writeTransactionalKind(QXmlStreamWriter& writer, QString const& kind);
         ...
         */
        void writeTransactionalBusWidth(QXmlStreamWriter& writer, QString const& busWidth);
         ...
         */
        void writeStructured(QXmlStreamWriter& writer, QSharedPointer<Structured> structured);
         ...
         */
        void writeStructuredType(QXmlStreamWriter& writer, QSharedPointer<Structured> structured);
         ...
         */
        void writeSubPorts(QXmlStreamWriter& writer, QSharedPointer<Structured> structured);
         ...
         */
        void writeArrays(QXmlStreamWriter& writer, QSharedPointer<QList<Array> > arrays);

        /*!
         *  Write the port arrays.
         *
         *    @param [in] writer        Used XML writer.
         *    @param [in] arrays        The containing port.
