...
The core functionality of Kactus2 is creating and reusing intellectual property. This can be done for individual components as well as designs and hierarchies incorporating multiple component instances. In addition, the tools supports configuration for improving reusability. Furthermore, Kactus2 features visualization such as design diagrams and integration support such as HDL generation and memory map visualization.
