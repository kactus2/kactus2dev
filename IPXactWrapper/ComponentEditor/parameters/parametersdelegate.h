 ...
 *  Created on: 4.4.2011
 *      Author: Antti Kamppi
 * 		filename: parametersdelegate.h
 */

#ifndef PARAMETERSDELEGATE_H
#define PARAMETERSDELEGATE_H

#include <QStyledItemDelegate>

/*! \brief The delegate that provides editors to be used to edit parameters.
 *
 */
...
public:
	 ...
	 *
	*/
	ParametersDelegate(QObject *parent);
...
private:
	...
	//! \brief No copying
	ParametersDelegate(const ParametersDelegate& other);

	//! No assignment
	ParametersDelegate& operator=(const ParametersDelegate& other);
};

#endif // PARAMETERSDELEGATE_H
