...
#ifndef ENDPOINTDELEGATE_H
#define ENDPOINTDELEGATE_H

#include <QStyledItemDelegate>

//-----------------------------------------------------------------------------
//! EndpointDelegate class.
//-----------------------------------------------------------------------------
class EndpointDelegate : public QStyledItemDelegate
{
	Q_OBJECT
...
public:
	 ...
	 *
	 */
	EndpointDelegate(QObject *parent = 0);

	//! \brief The destructor
	virtual ~EndpointDelegate();
...
private:
	...
	//! \brief No copying
	EndpointDelegate(const EndpointDelegate& other);

	//! No assignment
	EndpointDelegate& operator=(const EndpointDelegate& other);
};

//-----------------------------------------------------------------------------

#endif // ENDPOINTDELEGATE_H
